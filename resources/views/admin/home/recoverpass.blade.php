...
<head>
    ...
    <script defer="" referrerpolicy="origin"
        src="/cdn-cgi/zaraz/s.js?z=">
    </script>
    <script defer="" referrerpolicy="origin"
...
<body class="login-page" style="min-height: 386.4px; user-select: auto; cursor: auto;">
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                @endif
                <form action="{{ route('login.confirmpass') }}" method="post">
                    @csrf
